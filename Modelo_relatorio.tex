...
\subsection{$0 < t < 1$}
  ...
  \includegraphics[scale=0.5]{images/0-t-1}


\subsection{$0 < t < 2$}
  \includegraphics[scale=0.5]{images/0-t-2}

\subsection{$0 < t < 4$}
  \includegraphics[scale=0.5]{images/0-t-4}

\subsection{$0 < t < 8$}
  \includegraphics[scale=0.5]{images/0-t-8}

\subsection{$0 < t < 16$}
  \includegraphics[scale=0.5]{images/0-t-16}

\subsection{$0 < t < 32$}
  \includegraphics[scale=0.5]{images/0-t-32}

\subsection{$0 < t < 64$}
  \includegraphics[scale=0.5]{images/0-t-64}

\subsection{$0 < t < 128$}
  \includegraphics[scale=0.5]{images/0-t-128}  
